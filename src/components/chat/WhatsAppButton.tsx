...
const WhatsAppButton = ({
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 left-6 z-[55] w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group hover:scale-110"
