...
export default function Projects() {
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      // Backend-ul returnează obiectul { items, total_items }
      const items = data?.items || (Array.isArray(data) ? data : []);
      const total = data?.total_items || data?.total || items.length;
      ...
      <section className="relative min-h-[600px] lg:min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="container-section relative z-10 w-full pt-28 pb-12 md:py-32">
          <div className="max-w-4xl mx-auto md:mx-0 text-center md:text-left">
            <div className="badge-eco mb-6 inline-flex items-center">
            ...
            <h1 className="font-display font-bold text-white mb-6 leading-[1.1] tracking-tight text-[2.5rem] sm:text-[3.5rem] lg:text-[5rem]">
            ...
            <p className="text-white/90 mb-10 max-w-xl leading-relaxed text-base md:text-xl">
                ...
                {projects.map((project) => (
                  ...
                  >
                    ...
                    <div className="p-8">
                      ...
                      <p className="text-sm text-slate-500 flex items-center gap-1 mb-4 font-medium">
                      ...
                      {/* DESCRIERE PROIECT */}
                      {project.description && (
                        <p className="text-sm text-slate-600 line-clamp-2 mb-6 leading-relaxed italic">
                          {project.description}
                        </p>
                      )}
